...
import id.neotica.ui.shared.theme.DarkBackgroundV2
import id.neotica.ui.shared.theme.DarkPrimaryTransparent80
import kotlinx.coroutines.delay

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun BasicScaffoldScrollable(
    topBarTitle: String,
    ...
    Scaffold(
        ...
        topBar = {
            AnimatedVisibility(
                ...
                val containerColor = DarkBackgroundV2
                val scrolledContainerColor = DarkBackgroundV2
                ...
                TopAppBar(
                    ...
                    colors = TopAppBarDefaults.topAppBarColors(
                        containerColor = if (topBarBackground!= null) topBarColor else containerColor,
                        titleContentColor = White,
                        scrolledContainerColor = if (topBarBackground!= null) topBarColor else scrolledContainerColor
                    ),
                    navigationIcon = {
                        if (enableActionBar) {
                            IconButton(onClick = {
