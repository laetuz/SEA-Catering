...
fun CustomNavigationSuiteScaffold(
    ...
    navigationVisibility: Boolean = true,
    content: @Composable (insets: WindowInsets) -> Unit = {},
) {
    val insets = when (layoutType) {
    ...
    Surface(modifier = modifier, color = containerColor, contentColor = contentColor) {
        NavigationSuiteScaffoldLayout(
            ...
            content = {
                Box(
                    Modifier.consumeWindowInsets(insets)
                ) {
                    content(insets)
                }
            }
...
/**
 * Layout for a [CustomNavigationSuiteScaffold]'s content. This function wraps the [content] and places
 ...
 * the use of [CustomNavigationSuiteScaffold]. Example usage:
 *
 ...
 * used with the [CustomNavigationSuiteScaffold].
 *
 ...
 * @param layoutType the current [NavigationSuiteType] of the [CustomNavigationSuiteScaffold]. Defaults to
 *   [NavigationSuiteScaffoldDefaults.calculateFromAdaptiveInfo]
...
/**
 * Class that describes the different navigation suite types of the [CustomNavigationSuiteScaffold].
 *
...
/** Contains the default values used by the [CustomNavigationSuiteScaffold]. */
object NavigationSuiteScaffoldDefaults {
     ...
     * Usually used with the [CustomNavigationSuiteScaffold] and related APIs.
     *
     * @param adaptiveInfo the provided [WindowAdaptiveInfo]
     * @see CustomNavigationSuiteScaffold
     */
